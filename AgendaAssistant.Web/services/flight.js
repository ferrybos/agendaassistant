app.service('flightService', ['$http', '$log', '$filter', function ($http, $log, $filter) {
    ...
    this.getFlights = function (departureStation, arrivalStation, beginDate, endDate, paxCount, outboundMaxPrice, outboundWeekDays) {
        var weekDays = outboundWeekDays[0].value * 1 + outboundWeekDays[1].value * 2 + outboundWeekDays[2].value * 4 + outboundWeekDays[3].value * 8 + +outboundWeekDays[4].value * 16 + outboundWeekDays[5].value * 32 + outboundWeekDays[6].value * 64;
        ...
        //    endDate: endDate,
        //    paxCount: paxCount,
        //    outboundMaxPrice: outboundMaxPrice,
        //    outboundWeekDays: weekDays
        //};
